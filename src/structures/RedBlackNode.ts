...
export class RedBlackNode<K, V> {
    ...
    /** @internal */ _value: V
    /** @internal */ _parent: RedBlackNode<K, V> = RedBlackNode.nilNode as RedBlackNode<K, V>
    /** @internal */ _left: RedBlackNode<K, V> = RedBlackNode.nilNode as RedBlackNode<K, V>
    /** @internal */ _right: RedBlackNode<K, V> = RedBlackNode.nilNode as RedBlackNode<K, V>
    ...
    static readonly nilNode: RedBlackNode<any, any> = _nilNode()
    ...
    /** True if node is nil */
    get nil(): boolean { return this === RedBlackNode.nilNode }
  
    /** True if node is not nil */
    get ok(): boolean { return this !== RedBlackNode.nilNode}
  ...
  function _nilNode(): RedBlackNode<any, any> {
    return Object.freeze(
      new class extends RedBlackNode<unknown, unknown> {
        toString() { return '·' }
        _details() { return '(·)' }
