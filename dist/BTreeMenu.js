...
var BTreeMenu = /** @class */ (function () {
    function BTreeMenu() {
    }
    BTreeMenu.prototype.menu = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        console.log(menu);
                        return [4 /*yield*/, promptly.choose('Escoger opcion de menu: ', ['1', '2', '0'])];
                    case 2:
                        opcion = _b.sent();
                        _a = opcion;
                        switch (_a) {
    ...
    BTreeMenu.prototype.insert = function () {
        return __awaiter(this, void 0, void 0, function () {
            var degree, numero;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.tree == null)) return [3 /*break*/, 2];
    ...
    BTreeMenu.prototype.search = function () {
        return __awaiter(this, void 0, void 0, function () {
            var numero;
            return __generator(this, function (_a) {
                switch (_a.label) {
